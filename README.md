...
- [用户手册](docs/用户使用手册/用户手册.md) — 面向组态 / 运维人员
- [开发指南](docs/开发指南/开发指南.md) — 环境、命令、扩展点、关键机制
- [数据源手册](docs/数据源手册/roc-wes 数据源手册.md) — 7 种协议 ×（用户使用 + 开发）
- [Tauri 目标架构](docs/开发指南/tauri-目标架构.md) — 桌面版架构设计与实现状态
